					...
					<tr>
						<td align="center" valign="top" bgcolor="#d3be6c"
							...
							<div style="font-size: 32px; color: crimson;">
								<br> Dear ${customer.getCust_name()} <br><br>
							</div>
							<div style="font-size: 24px; color: blue;">
								<br> Click below link to verify your account creation...<br> 
								<h3><a style="font-size: 24px; color: blue;" href="http://localhost:8080/customers/setpassword?token=${customer.getToken()}">Verify my account</a></h3>
